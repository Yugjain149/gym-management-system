      ...
      <div class="row">
        ...
        <div class="col-md-4">
          <div class="card">
            ...
            <div class="card-body" style="background-color:hsl(180, 12%, 8%);">
              <center>
              <h5 style="color:white">Admin Login</h5><br>
              <form class="form-group" method="POST" action="admin-panel.php">
                <div class="row">
                  <div class="col-md-4" style="color:white"><label>Username: </label></div>
                ...
                <center><input type="submit" id="inputbtn" name="login_submit" value="Login" class="btn btn-primary" style="background-color:hsl(79, 72%, 55%); border-color:hsl(79, 72%, 55%)"></center>
              </form>
